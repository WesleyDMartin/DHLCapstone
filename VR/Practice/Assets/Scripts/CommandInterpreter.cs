...
namespace Assets.Scripts
{
    ...
    internal static class CommandInterpreter
    {
        ...
        {
            ReadyToRead = false;
            AsynchronousClient.RequestAnswer("SETCULTURE|" + culture);
        }

        public static void TextToSpeech(string text)
        {
            ReadyToSpeak = false;
            AsynchronousClient.RequestAnswer("SPEAK|" + text);
            ReadyToSpeak = true;
        }
    }
    ...
    public class AsynchronousClient
    {
        ...
        private static string StartClient(string message)
        {
            ...
            try
            {
                ...
                client.Close();
                CommandInterpreter.Response = JsonConvert.DeserializeObject<Response>(response);
                return response;
            }
            catch (Exception e)
            {
